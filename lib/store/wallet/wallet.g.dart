...
mixin _$Wallet on WalletBase, Store {
    ...
    double get localCurrencyPrice {
        _$localCurrencyPriceAtom.context.enforceReadPolicy(_$localCurrencyPriceAtom);
    ...
    final _$hasExceededBorrowLimitAtom = Atom(name: 'WalletBase.hasExceededBorrowLimit');

    @override
    bool get hasExceededBorrowLimit {
        _$hasExceededBorrowLimitAtom.context.enforceReadPolicy(_$hasExceededBorrowLimitAtom);
    ...
    set hasExceededBorrowLimit(bool value) {
        ...
        }, _$hasExceededBorrowLimitAtom, name: '${_$hasExceededBorrowLimitAtom.name}_set');
    }

    final _$hasReceivedSubscribeResponseAtom = Atom(name: 'WalletBase.hasReceivedSubscribeResponse');

    @override
    bool get hasReceivedSubscribeResponse {
        _$hasReceivedSubscribeResponseAtom.context.enforceReadPolicy(_$hasReceivedSubscribeResponseAtom);
    ...
    final _$getBalanceAndInsertBorrowedAsyncAction = AsyncAction('getBalanceAndInsertBorrowed');
    ...
    final _$findAccountsWithNameLikeAsyncAction = AsyncAction('findAccountsWithNameLike');
